...
namespace Complete
{
    public class TankMovement : MonoBehaviourPunCallbacks
    {
        ...
        private string m_TurretName;
        private float m_TureetRotateInputValue;
        ...
        private void Update()
        {
            ...
            m_TureetRotateInputValue = Input.GetAxis(m_TurretName);
